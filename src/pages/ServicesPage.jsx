...
<section className="py-24 px-4 md:px-8 max-w-7xl mx-auto space-y-32">
  ...
  {/* Service 2: Plantation Tour — NEW (placeholder content) */}
      ...
      <div className="bg-white/95 backdrop-blur-sm p-8 md:p-14 shadow-xl border border-gray-100">
        ...
        <div className="pt-6 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <p className="text-xl font-serif text-[#2D6A2D] font-bold">Pricing on Request</p>
              <p className="text-xs font-bold tracking-widest uppercase text-gray-500 mt-1">Duration & details vary</p>
            </div>
            <a 
              href="https://wa.me/94702900500" 
              target="_blank" 
