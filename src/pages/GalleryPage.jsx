...
export default function GalleryPage({ navigate }) {
  ...
  return (
    ...
    {/* <section className="relative pt-32 pb-16 px-8 text-center overflow-hidden">
        <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-[#e8e4d9] to-[#f9f8f3] opacity-50"></div>
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          <span className="text-[#c8a951] text-xs font-semibold tracking-[0.4em] uppercase mb-6 relative">
            <span className="absolute -left-12 top-1/2 w-8 h-[1px] bg-[#c8a951]"></span>
            Visual Narrative
            <span className="absolute -right-12 top-1/2 w-8 h-[1px] bg-[#c8a951]"></span>
          </span>
          <h1 className="text-5xl md:text-7xl font-serif text-[#1b3b22] mb-6 tracking-tight leading-tight">
            Capturing the Essence <br className="hidden md:block"/> of the Highlands
          </h1>
